    ...
    <>
      <div className="liquid-glass-strong rounded-3xl p-5 md:p-6 border border-white/10 shadow-xl">
        <div className="flex items-center gap-3 mb-4 md:mb-5">
          <div className="w-9 h-9 md:w-10 md:h-10 rounded-2xl bg-amber-500/20 text-amber-400 flex items-center justify-center border border-amber-500/30 flex-shrink-0">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/>
            </svg>
          </div>
          <div className="min-w-0">
            <h3 className="text-base md:text-lg font-bold text-white tracking-tight">{lang === "bn" ? "গ্যালারি" : "Class Gallery"}</h3>
            <p className="text-xs text-slate-400 truncate">{lang === "bn" ? "ক্লাসের মুহূর্ত ও প্রকল্প" : "Class moments & projects"}</p>
          </div>
        </div>
